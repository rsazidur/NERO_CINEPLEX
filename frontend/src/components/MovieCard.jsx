...
const MovieCard = ({movie}) => {
  ...
  return (
    ...
    hover:-translate-y-1 trasition duration-300 w-66'>
        ...
        <div className='flex items-center justify-between mt-4 pb-3'>
            <button className='px-4 py-2 text-xs bg-primary hover:bg-primary-dull
            transiton rounded-full font-medium cursor-pointer'>Buy Tickets</button>
